...
class Vote {
  constructor() { this[aVote] = {}; }

  set userId(userId) { this[aVote].userId = userId; }

  set answerId(answerId) { this[aVote].answerId = answerId; }

  set vote(vote) { this[aVote].vote = vote; }

  static createTable(callback) {
    const createTableQuery = 'CREATE TABLE IF NOT EXISTS votes ('
