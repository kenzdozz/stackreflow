...
class User {
  ...
  static createTable(callback) {
    const createTableQuery = 'CREATE TABLE IF NOT EXISTS users (' + ' id SERIAL PRIMARY KEY,' + ' name varchar(100),' + ' email varchar(100) UNIQUE,' + ' password varchar(255),' + ' created_at date DEFAULT CURRENT_TIMESTAMP,' + ' updated_at date DEFAULT CURRENT_TIMESTAMP );';
