...
var Question = function () {
  ...
  _createClass(Question, [{
    ...
    value: function createTable(callback) {
      var createTableQuery = 'CREATE TABLE IF NOT EXISTS questions (' + ' id SERIAL PRIMARY KEY,' + ' user_id integer REFERENCES users(id) ON DELETE CASCADE,' + ' title varchar(100),' + ' body varchar(3000),' + ' tags varchar(255) NULL,' + ' answer_count integer DEFAULT 0,' + ' view_count integer DEFAULT 0,' + ' created_at date DEFAULT CURRENT_TIMESTAMP,' + ' updated_at date DEFAULT CURRENT_TIMESTAMP );';
